...
#define emailSenderAccount    "sender_example@email.com"    //To use send Email for Gmail to port 465 (SSL), less secure app option should be enabled. https://myaccount.google.com/lesssecureapps?pli=1
#define emailSenderPassword   "sender_example_Password"

#define emailRecipient        "recipient1_example@email.com"
